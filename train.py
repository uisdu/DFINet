...
from utils import (
    ...
    epoch_time, rle_encode, rle_decode, print_and_save, load_data1,load_data
    )
from model import *
...
if __name__ == "__main__":
    ...
    """ Training logfile """
    train_log_path = os.path.join(base_dir, "train_log.txt")
    ...
    num_epochs = 200
    lr = 0.00007
    checkpoint_path = os.path.join("/home/visionx/EXT-4/lcj/DFINet-master/",base_dir, "checkpoint.pth")

    """ Dataset """
    path = "/home/visionx/EXT-4/lcj/new/IRSTD-1k-80_20"
    (train_x, train_y), (valid_x, valid_y) = load_data1(path)

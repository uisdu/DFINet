...
if __name__ == "__main__":
    ...
    """ Directories """
    create_dir("/home/visionx/EXT-4/lcj/DFINet/NUDT-SIRST")

    """ Training logfile """
    train_log_path = "/home/visionx/EXT-4/lcj/DFINet/NUDT-SIRST/train_log.txt"
    if os.path.exists(train_log_path):
        print("Log file exists")
    else:
        train_log = open("/home/visionx/EXT-4/lcj/DFINet/NUDT-SIRST/train_log.txt", "w")
        train_log.write("\n")
        train_log.close()
    ...
    num_epochs = 300
    lr = 0.00007
    checkpoint_path = "/home/visionx/EXT-4/lcj/DFINet/NUDT-SIRST/checkpoint.pth"

    """ Dataset """
    path = "/home/visionx/EXT-4/lcj/new/NUDT-SIRST"
